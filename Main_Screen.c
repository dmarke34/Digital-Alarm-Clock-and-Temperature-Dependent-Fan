...
void Update_Screen(void)
{
    ...
    time[3]  = (minute>>4) + '0'; // add code                   // Minute MSD
    time[4]  = (minute & 0x0f) + '0'; // add code               // Minute LSD
    time[6]  = (second>>4) + '0'; // add code                   // Second MSD
    time[7]  = (second & 0x0f) + '0'; // add code               // Second LSD
    date[0]  = (month>>4)+ '0'; // add code                   // Month MSD
    date[1]  = (month & 0x0f) + '0'; // add code                // Month LSD
    date[3]  = (day>>4) + '0'; // add code                      // Day MSD
    date[4]  = (day & 0x0f) + '0'; // add code                   // Day LSD
    date[6]  = (year>>4) + '0'; // add code                     // Year MSD
    date[7]  = (year & 0x0f) + '0'; // add code                  // Year LSD
    ...
    Heater_Set_Temp_Txt[1] = ((heater_set_temp/10)%10) + '0'; // add code 
    ...
    Volt_Txt[2] = ((volt - (int)volt)*10)+ '0'; // add code 
